...
# Test cases with expected behaviors - DIVERSE for better GEPA learning
TEST_CASES = [
    ...
    # 2. OVER-SPECIFIC - Tests when NOT to ask questions
    {
    ...
    # 3. AMBIGUOUS INTENT - Makeup vs skincare disambiguation
    {
    ...
    # 4. BRAND-SPECIFIC - Should search immediately but offer refinement
    {
    ...
    # 5. PRICE-FOCUSED - Tests handling of budget constraints
    {
    ...
    # 6. EDGE CASE: Contradictory requirements
    {
        ...
        "ideal_outcome": {
            "turns": 3,
            "relevance": 7.0,  # Lower expectation for contradictory query
            "satisfaction": True
        }
    },

    # 7. INFORMAL/MISSPELLED - Tests robustness
    {
        "query": "moisterizer for acnee prone skin",
        "difficulty": "medium",
        "expected": {
            "should_search_immediately": True,  # Should handle spelling
    ...
    # 8. NEGATIVE CONSTRAINTS - Filter exclusions
    {
    ...
    # 9. MULTI-PRODUCT - Tests prioritization
    {
        "query": "cleanser and moisturizer for sensitive skin",
        "difficulty": "medium",
        "expected": {
            "should_clarify": True,
            "clarify_first": "prioritization",  # Which product first?
    ...
    # 10. CONTEXT-DEPENDENT - Implicit use case
    {
        "query": "something for after the gym",
        "difficulty": "hard",
        "expected": {
            "should_clarify": True,
            "infer_use_case": "post-workout skincare",
            "expected_question_topics": ["product_type", "skin_concerns", "preferences"]
        },
        "ideal_outcome": {
            "turns": 4,
            "relevance": 7.5,
